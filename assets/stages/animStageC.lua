...
--Twitter Window Animation
    ...
    addLuaSprite('bgchar3', false); --Newgrounds Window
    addLuaSprite('bgchar2', false); --Twitter Window
    addLuaSprite('bgchar1', false); --Google Window
    addLuaSprite('bgchar', false); --Fires
    addLuaSprite('floor', false); --Floor
end
